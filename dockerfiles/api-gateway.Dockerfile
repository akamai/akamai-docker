...
RUN apk add --no-cache git upx \
  ...
  && upx --brute -o/akamai-api-gateway.upx /akamai-api-gateway \
  && upx --brute -o/akamai-api-keys.upx /akamai-api-keys \
  && upx --brute -o/akamai-api-security.upx /akamai-api-security \
